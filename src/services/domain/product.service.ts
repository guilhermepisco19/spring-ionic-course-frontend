...
export class ProductService {
    ...
    findByCategory(category_id : string, page : number = 0, linesPerPage : number = 24) {
        return this.http.get(`${API_CONFIG.baseUrl}/products?categorias=${category_id}&page=${page}&linesPerPage=${linesPerPage}`);
    }
    ...
    getSmallFromBucket(id : string) : Observable<any> {
